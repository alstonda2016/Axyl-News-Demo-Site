          ...
          function gtWhiteHouse(){
           ...
           function gtHome() {
                       window.location = "hometest.html"
                          ...
                          var ref = firebase.database().ref().child('CATEGORIES').child('i002').orderByChild('topicCreationTimeInverse').limitToFirst(11);
...
*/
        var topicCategory = childData.topicCategory;
                          ...
                          var topArticleRef = firebase.database().ref().child('CATEGORIES').child('i002').orderByChild('topicClickRank').limitToFirst(5);
...
/*
                                      ...
                                      localStorage.setItem("rd3", rd3);
                                      localStorage.setItem("storageName", childKey);
                                      localStorage.setItem("topicName", tN);       //window.location = "www.example.com"
                                      window.location = "topic.html"
*/
        var topicCategory = childData.topicCategory;
...
var ldrV = document.getElementById("ldr");
                            ldrV.style.visibility = "visible"
                              ...
                              var ref = firebase.database().ref().child('CATEGORIES').child('i002').orderByChild('topicCreationTimeInverse').startAt(nVal).limitToFirst(11);
                              ref.once('value', function (snapshot) {
  var ldrV = document.getElementById("ldr");
                                    ldrV.style.visibility = "hidden"
...
*/
        ...
        var topicCategory = childData.topicCategory;
                              ...
                              // bigy.innerText = indexy.toString();
