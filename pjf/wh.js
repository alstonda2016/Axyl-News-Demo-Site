          ...
          function gtWhiteHouse(){
           ...
           function gtHome() {
                       window.location = "hometest.html"
                          ...
                          var ref = firebase.database().ref().child('CATEGORIES').child('i003').orderByChild('topicCreationTimeInverse').limitToFirst(11);
...
*/
        ...
        var topicCategory = childData.topicCategory;
                          ...
                          var topArticleRef = firebase.database().ref().child('CATEGORIES').child('i003').orderByChild('topicClickRank').limitToFirst(5);
...
var ldrV = document.getElementById("ldr");
                            ldrV.style.visibility = "visible"
                              ...
                              var ref = firebase.database().ref().child('CATEGORIES').child('i003').orderByChild('topicCreationTimeInverse').startAt(nVal).limitToFirst(11);
                              ref.once('value', function (snapshot) {
  var ldrV = document.getElementById("ldr");
                                    ldrV.style.visibility = "hidden"
